...
function createState(tutorial: ProviderTutorial): UseProviderCardStateResult {
  return {
    ...
    setTempKeyGroups: () => undefined,
    setTempUrl: () => undefined,
    startEditKey: () => undefined,
    toggleKeyGroupVisibility: () => undefined,
    updateTempKeyGroup: () => undefined,
    handleSaveKeyGroups: () => undefined,
    handleCancelKeyGroups: () => undefined,
